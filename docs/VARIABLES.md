...
- `linux_freeipa_enroll_join_timeout_diagnostic_http_timeout`: HTTP timeout in seconds for the guest-side `https://<ipa-server>/ipa/json` timeout diagnostics probe; defaults to `10`
