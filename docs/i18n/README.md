...
English [README.md](../../README.md) remains the canonical and complete documentation source.
This directory provides full translated README files for common world languages.
